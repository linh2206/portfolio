...
const experiences = [
  ...
  { company: 'Hvision', period: 'Feb 2024 – May 2025', role: 'Full-stack Developer', color: 'from-violet-400 to-purple-500', dot: '#a78bfa',
    items: ['Vang Tat Mine Management System: Designed and developed internal system for employee info and warehouse inventory', 'Implemented modules for employee records, shift assignments, and leave management', 'Built warehouse inventory tracking with stock movement, request handling, and reporting'],
    tech: ['Next.js', 'NestJS', 'MySQL', 'MongoDB', 'Go', 'Redis', 'Tailwind CSS', 'Figma', 'GitHub Actions', 'Ubuntu', 'VMware ESXi'] },
  { company: 'WOSS Corporation', period: 'Mar 2022 – Feb 2024', role: 'Full-stack Developer', color: 'from-pink-400 to-rose-500', dot: '#f472b6',
    items: ['Media Hub Platform (MHP): Contract management, video approval workflow, broadcast scheduling', 'IoT Smart Battery: Processed real-time GPS data and integrated with UI', 'Education Platform: Interactive learning tools and data dashboards'],
    tech: ['Node.js', 'NestJS', 'React', 'Next.js', 'Python', 'Docker', 'Jenkins', 'PostgreSQL', 'MySQL', 'Ant Design', 'MUI', 'Figma', 'Ubuntu'] },
  { company: 'ROBUSTA', period: 'Jan 2021 – Jan 2022', role: 'Developer', color: 'from-orange-400 to-amber-500', dot: '#fb923c',
    items: ['Xuyen A Hospital: REST APIs (Laravel) + Frontend (ReactJS)', 'Online School: Video calling (Flutter), revenue reporting app (React Native)', 'Learned and experimented with mobile app technologies and cross-platform solutions'],
  ...
  { company: 'ECOMEASY', period: 'May 2020 – Dec 2020', role: 'Developer', color: 'from-emerald-400 to-teal-500', dot: '#34d399',
    items: ['Built APIs for e-commerce platform with NodeJS and MongoDB', 'Deployed AWS services for storage and hosting'],
  ...
  { company: 'HUTECH University', period: 'Jul 2019 – Jan 2020', role: 'Intern', color: 'from-yellow-400 to-orange-500', dot: '#facc15',
    items: ['Developed feedback collection website (NodeJS, EJS, PostgreSQL)', 'Designed responsive mobile-first layout (Bootstrap)', 'Studied Angular and ReactJS during internship'],
    tech: ['Node.js', 'EJS', 'PostgreSQL', 'Bootstrap', 'Angular', 'ReactJS'] },
]
